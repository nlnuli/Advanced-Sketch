...
def test_find_heavy_hitters():
    ...
    assert len(set(top_100.index) & set(heavy_hitters)) > HEAVY_HITTERS_THRESHOLD, "Unable to detect heavy hitters above set threshold"
...
if __name__ == "__main__":
    ...
    assert (asizeof.asizeof(sketch.sketch)+asizeof.asizeof(sketch.auxiliary_storage))/(1024**2) < 1, "Sketch Size is not less than 1 Megabyte"
